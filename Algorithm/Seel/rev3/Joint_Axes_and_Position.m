...
%   o1 position of imu1
%   o2 position of imu2
function [j1,j2,ej,o1,o2,eo] = Joint_Axes_and_Position(Trial)
...
%         j1 = [sin(psi1)*cos(theta1),sin(psi1)*sin(theta1),cos(psi1)];
%         j2 = [sin(psi2)*cos(theta2),sin(psi2)*sin(theta2),cos(psi2)];
